...
export default function Dropdowns(props: DropdownsProps) {
    ...
    return (
        <Menu as="div" className="relative inline-block text-left ">
            ...
            >
                <Menu.Items className="origin-top-right absolute z-10 right-0 sm:left-0 mt-2 w-44 rounded-md shadow-lg bg-white ring-1 ring-black  divide-y divide-gray-100 ring-opacity-5 focus:outline-none">
                    <div className="py-1">
                        {copyContent && (
                            <Menu.Item>
                                {({ active }) => (
